...
/*
 ...
 | Peregrin Framework                                                      |
 +------------------------------------------------------------------------+
 | Copyright (c) 2011-2013 Peregrin Team (http://www.peregrinphp.com)       |
 +------------------------------------------------------------------------+
 ...
 | to license@peregrinphp.com so we can send you a copy immediately.       |
 +------------------------------------------------------------------------+
...
ZEPHIR_INIT_CLASS(Peregrin_Version) {
	...
	ZEPHIR_REGISTER_CLASS(Peregrin, Version, peregrin, version, peregrin_version_method_entry, 0);
